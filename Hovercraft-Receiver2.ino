// This is the receiver side for the hovercraft. This takes in data and transmitts it to the ESCs. 
// There is also two way communications between the transmitter and the hovercraft so telemetry data 
// is sent back.
#include <Servo.h>
#include <SPI.h>
#include "nRF24L01.h"
...
//     }
    ...
    //while( radio.available(&pipeNo)){
      ...
      if (!radio.write( &telemetrydata, 10 )){ //If we wander out of range
        timeoutcounter++;
        if(timeoutcounter>200){ //Timeout before setting out of range bit
          //Serial.print("Out of Range, Skirt Thrust held at ");
          //Serial.println(skirtInput);
